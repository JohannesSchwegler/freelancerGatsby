  ...
  return (
    <Layout>
      ...
      <div class="js__gutter">
        <h1 class="js__mainheader">Impressum</h1>
        <div class="impressum__content">
          ...
          <p>
            Berufsbezeichnung: Webentwickler, Webdesigner
            <br />
            Zust&auml;ndige Kammer: Industrie - und Handelskammer Bodensee -
            Oberschwaben
            <br />
