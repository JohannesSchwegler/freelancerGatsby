...
const ProjectView = ({ projects }) => {
  return (
    <section
      id="projects"
      className="project js__section aos-init aos-animate"
      data-aos="fade-up"
    >
      <h1 className="js__header">Meine Projekte</h1>
        ...
        if (i % 2 === 0) {
          return (
            <div className="project__item" key={project.id}>
              <a className="project__img">
                <div className="project__ratio">
                  <Image
                    style={{ paddingBottom: "red" }}
                    fluid={image}
                    alt={title}
                    divStyle={{ objectFit: "contain" }}
                  />
                </div>
              </a>

              <div className="project__content">
                <span className="project__featured">Featured Project</span>
                <h2 className="project__title">{title}</h2>
                <div className="project__description">
                  <p className="js__subtext">{description}</p>
                  <p></p>
                </div>
                <ul>
                ...
                <div className="project__links">
                  <a
                    href="https://freelancer.local/instaclone/"
                    target="_blank"
          ...
          return (
            <div className="project__item" key={project.id}>
              <a className="project__img reversed">
                <div className="project__ratio">
                  <Image fluid={image} alt={title} />
                </div>
              </a>

              <div className="project__content reversed">
                <span className="project__featured">Featured Project</span>
                <h2 className="project__title">{title}</h2>
                <div className="project__description">
                  <p className="js__subtext">{description}</p>
